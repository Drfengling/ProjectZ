...
namespace 卓汇数据追溯系统
{
    public partial class frmMain : Form
    {
        ...
        /// </summary>
        /// <returns></returns>
        private bool MQTT_Connect(string HostName,string txtEMT,string txtMQTTUserName,string txtMQTTPassword)
        {
            bool result = false;
            ...
            {
                Console.WriteLine($"{HostName} Connect Fail, {ex.Message}!");
            }
            return result;
        }
        ...
        private void Client_MqttMsgPublishReceived(object sender, MqttMsgPublishEventArgs e)
        {
            ...
            {
                MQTT_Connect("10.143.19.45", "T202108019088", "assembly", "jgp123");
            }
